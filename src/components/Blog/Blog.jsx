...
const Blog = ({blog, handleAddToBookmarks, handleMarkAsRead}) => {
  ...
  return (
    <div className="w-[1000px] mb-10">
      ...
      <img className="lg:w-[845px] lg:h-[450px] mb-8" src={cover} alt="" />
        ...
        <div className="flex items-center">
          ...
          <button onClick={() => handleAddToBookmarks(blog)} className="text-[#11111199] text-xl font-medium"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        <h2 className="text-[40px] w-[737px] font-bold mb-4">{title}</h2>
